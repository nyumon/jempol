...
public class OneFragment extends Fragment{
    ...
    private List<ItemObject> getAllItemList(){
        ...
        allItems.add(new ItemObject("Aplikasi Jempol", "12 minute ago", R.drawable.jempol));
        allItems.add(new ItemObject("Percobaan", "12 minute ago", R.drawable.jempol));
        allItems.add(new ItemObject("aplikasi", "12 minute ago", R.drawable.jempol));
        allItems.add(new ItemObject("boom defuse", "12 minute ago", R.drawable.jempol));
        allItems.add(new ItemObject("teroris", "12 minute ago", R.drawable.jempol));
        return allItems;
    }
